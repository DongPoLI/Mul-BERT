...
class bertForRC_BERT(BertPreTrainedModel):
    def __init__(self, config, tokenizer, max_sentence_length=128, num_labels=19,
                 pretrained_weights="bert-base-uncased"):
        super(bertForRC_BERT, self).__init__(config)  # config
    ...
    def forward(self, x, x_mark_index_all):
