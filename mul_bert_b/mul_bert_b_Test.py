...
from Mul_bert_B_Model import bertForRC_BERT
...
model = bertForRC_BERT(config, rt_tokenizer, max_sentence_length=max_sentence_length, is_cuda=is_cuda, pretrained_weights=pretrained_weights)
